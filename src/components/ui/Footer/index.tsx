...
import { Grid, Flex, Block, Heading, Text } from '@shared';

export const Footer = () => {
    return (
        <Block as="footer" className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
                ...
                <Grid cols={1} className="md:grid-cols-4" gap={8}>
                    <Block className="col-span-1 md:col-span-1">
                        <Flex align="center" className="mb-4">
                            ...
                            <Text as="span" className="ml-2 text-xl font-bold text-white">SpendWise</Text>
                        </Flex>
                    ...
                    <Block>
                        <Heading as="h3" className="text-white font-semibold mb-4">Product</Heading>
                    ...
                    <Block>
                        <Heading as="h3" className="text-white font-semibold mb-4">Company</Heading>
                        <ul className="space-y-2 text-sm">
                    ...
                    <Block>
                        <Heading as="h3" className="text-white font-semibold mb-4">Legal</Heading>
                        <ul className="space-y-2 text-sm">
