...
const testimonials = [
    {
        quote: "ExpenseFlow has completely changed how we manage our startup's burn rate. The multi-account tracking is a lifesaver.",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-lg text-gray-600">
                        See what our users have to say about their experience with ExpenseFlow.
                    </p>
                </div>
