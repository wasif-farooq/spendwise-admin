        ...
        <section className="relative pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    >
                        <span className="inline-flex items-center rounded-full px-4 py-1 text-sm font-medium text-primary bg-primary/10 mb-6">
                            🚀 Smart Multi-Account Expense Tracking
                        </span>
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-gray-900 mb-6">
                            Master Your Finances with <span className="text-primary">ExpenseFlow</span>
                        </h1>
                    ...
                    <motion.div
                        ...
                        className="grid grid-cols-2 md:grid-cols-4 gap-4 text-left max-w-3xl mx-auto mb-16"
                    >
                        {[
                ...
                >
                    ...
                    <div className="aspect-[16/9] bg-gray-50 flex items-center justify-center relative group">
                        <div className="absolute inset-0 bg-gradient-to-tr from-gray-100 to-gray-50 opacity-50" />
                        ...
                        <div className="absolute top-4 left-4 right-4 bottom-4 border-2 border-dashed border-gray-200 rounded-lg opacity-50"></div>
                    </div>
                </motion.div>
            </div>
