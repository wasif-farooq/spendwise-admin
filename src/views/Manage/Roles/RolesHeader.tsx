        ...
        <Flex as="header" direction="col" gap={6}>
            ...
            {!canAddRole && (
                <LimitBanner
                    ...
                    current={roleAccess.current}
                    limit={roleAccess.limit}
                    variant="warning"
                />
            )}
            ...
            <Flex direction="col" justify="between" gap={6} className="lg:flex-row lg:items-center">
                <Block>
                    ...
                    <Text color="text-gray-500" weight="medium" className="mt-1">
                        Define granular access for your team members. ({roleAccess.current}/{roleAccess.limit === -1 ? '∞' : roleAccess.limit} custom roles)
                    </Text>
                </Block>
