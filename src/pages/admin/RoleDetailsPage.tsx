import { useAdminRoleEditor } from '@/hooks/features/admin/useAdminRoleEditor';
...
export const RoleDetailsPage = () => {
    ...
    if (loadingData) {
        return <Block className="p-8"><Text className="animate-pulse text-gray-400">Loading role data...</Text></Block>;
    }
            ...
            <Flex as="header" direction="col" justify="between" gap={6} className="sm:flex-row sm:items-center">
                <Flex align="center" gap={4}>
                    ...
                    <Block>
                        ...
                        <Text className="text-gray-500 font-medium mt-1">Define precise access levels and understand their impact.</Text>
                    </Block>
                </Flex>
                <Flex align="center" gap={4}>
                    <Button
                    ...
                    <Block className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/50 space-y-6">
                        ...
                        <Block className="space-y-2">
                            ...
                            <textarea
                                ...
                                className="w-full bg-gray-50 border-none rounded-2xl p-4 focus:ring-2 focus:ring-primary font-medium min-h-[120px] resize-none outline-none"
                            />
                        </Block>
                        ...
                        <Flex align="start" gap={4} className="bg-amber-50 p-6 rounded-3xl border border-amber-100">
                            ...
                            <Block>
                                <Text className="text-xs font-black uppercase tracking-widest text-amber-900">Security Note</Text>
                                    ...
                                    {resource.permissions.map((perm) => {
                                        ...
                                        return (
                                            <Block
                                                ...
                                                className={`p-8 cursor-pointer transition-all hover:bg-gray-50/80 group ${isSelected ? 'bg-blue-50/50' : ''
                                                    }`}
                                            >
