    ...
    return (
        <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-8">
            <header className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                ...
                >
                    <h1 className="text-4xl font-black text-gray-900 tracking-tight">Manage</h1>
                    <p className="text-gray-500 mt-1 font-medium">Configure your organization and team preferences.</p>
                </motion.div>
