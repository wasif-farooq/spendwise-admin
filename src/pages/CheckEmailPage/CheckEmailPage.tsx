...
const CheckEmailPage = () => {
    return (
        <Container as="div" size="full" className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
                <Flex justify="center" className="mx-auto h-16 w-16 rounded-full bg-blue-100">
                    <Mail className="h-8 w-8 text-primary" />
                </Flex>

                <Heading as="h2" size="3xl" weight="bold" color="text-gray-900" className="mt-6">Check your email</Heading>
